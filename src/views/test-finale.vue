<template>
	<div>
		...
		<template v-else>
          ...
          <span :style="{width: `${conclusion.scores_summ / conclusion.max_score * 100}%`}">
			...
			class="description description__point q-mb-lg">
				<div class="text-bold text-h2 q-mb-md text-accent">{{ conclusion.name || 'название интерпритации' }}</div>
